...
public class SupervisedBPEClassifierTest extends AbstractClassifierTest {
  @Override
  ...
  protected Classifier initClassifier() {
    WEASELCharacterClassifier.transformer = new SupervisedBPETransformer(WEASELCharacterClassifier.maxS, true);
