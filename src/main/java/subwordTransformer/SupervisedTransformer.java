...
/**
 * Transforms words to subwords after supervised training on a given dataset.
 * 
 * @param <P> the parameter type that the transformer uses
 */
public abstract class SupervisedTransformer<P extends Parameter> extends SubwordTransformer<P> {
   ...
   *                            -1)
   */
  public SupervisedTransformer(int alphabetSize, boolean positionalAlphabets, short fillCharacter) {
   ...
   *                            different meanings
   */
  public SupervisedTransformer(int alphabetSize, boolean positionalAlphabets) {
